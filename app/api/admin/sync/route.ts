...
`
        ...
        if (!pushedToGithub) {
          ...
          try {
            ...
            log("Terminal git push skipped; GitHub updated via API token. Continuing with local VPS update...")
          }
        } else {
          log("GitHub repository updated via API token. Continuing with local VPS update...")
        }
