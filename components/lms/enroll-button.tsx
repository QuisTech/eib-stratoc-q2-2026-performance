  ...
  if (isCompleted) {
    return (
      <Button
        ...
        variant="outline"
        disabled
        className="disabled:opacity-100 font-medium text-emerald-700 dark:text-emerald-300 border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-950/50"
      >
